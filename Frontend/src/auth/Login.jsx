            ...
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              <div className="m-2 py-5 text-center">
                <h1 className="text-white " style={{ fontSize: "2rem" }}>
                  Build healthy habits with the all-in-one food,<br></br>
                    ...
                    <div className="login_content p-5 shadow rounded-5">
                      <div className="text-center pb-2">
                        <h4 className="text-start text-white">
                          Login to Expolore the Destinations
                        </h4>
                      </div>
                      <form onSubmit={handleLogin}>
                        ...
                        <div className="submit_btn">
                          <button className="btn btn-outline-light rounded-pill px-5 py-2 mt-3">
                            Login
                          </button>
                        </div>
                        <p className="text-light mt-3">
                          Don't have account{" "}
                          <a href="/sign-up" className="text-ligth fw-bold">
                            Click here
                          </a>{" "}
                          to Signup
                        </p>
                        ...
                        <div className="d-flex justify-content-start">
                          <div>
                            <a href="">
                              <i
                                class="fa fs-4 text-white fa-facebook"
                                aria-hidden="true"
                              ></i>
                            </a>
                          </div>
                          <div className="px-2">
                            <a href="">
                              <i
                                class="fa fs-4 text-white fa-instagram"
                                aria-hidden="true"
                              ></i>
                            </a>
                          </div>
                          <div className="px-2">
                            <a href="">
                              <i
                                class="fa fs-4 text-white fa-twitter"
                                aria-hidden="true"
                              ></i>
                            </a>
                          </div>
                          <div className="px-2">
                            <a href="">
                              <i
                                class="fa fs-4 text-white fa-linkedin"
                                aria-hidden="true"
                              ></i>
                            </a>
                          </div>
