          ...
          <div className="row justify-content-center">
            ...
            <div className="col-xs-12 col-sm-12 col-md-3 col-lg-3">
              <div className="item bg-white shadow-sm p-3 text-center">
                <img
                  src="https://assets.licious.in/OMS-ProductMerchantdising/6a2a716e-bb23-c44c-cca1-b50a5d9619c0/original/1706699523726.jpg"
                  alt="chicken"
                  className="img-fluid"
                  style={{
                    width: "100%",
                ...
                <button
                  ...
                  onClick={() =>
                    addToCart({ id: 1, price: 5, name: "Chicken" })
                  }
                >
                  Add to Cart
                </button>
            ...
            <div className="col-xs-12 col-sm-12 col-md-3 col-lg-3">
              <div className="item bg-white shadow-sm p-3 text-center">
                <img
                  src="https://www.licious.in/_next/image?url=https%3A%2F%2Fdao54xqhg9jfa.cloudfront.net%2FOMS-ProductMerchantdising%2Fee837ddb-f60b-d4db-7bc6-b8e3a234ff5b%2Foriginal%2FPDP_10._Goat_Curry_Cut_(500g)-13_(1).jpg&w=750&q=75"
                  className="img-fluid"
                />
                ...
                <button
                  className="btn btn-success"
                  onClick={() =>
                    addToCart({ id: 2, price: 10, name: "Mutton" })
                  }
                >
                  Add to Cart
                </button>
            ...
            <div className="col-xs-12 col-sm-12 col-md-3 col-lg-3">
              <div className="item bg-white shadow-sm p-3 text-center">
                <img
                  src="https://www.licious.in/_next/image?url=https%3A%2F%2Fassets.licious.in%2FOMS-ProductMerchantdising%2F075e5914-fc21-489e-fa68-f2eef2a97830%2Foriginal%2F1701765913378.jpg&w=750&q=75"
                  className="img-fluid"
                />
                ...
                <button
                  className="btn btn-success"
                  onClick={() => addToCart({ id: 3, price: 8, name: "Fish" })}
                >
                  Add to Cart
                </button>
              </div>
            ...
            <div className="col-xs-12 col-sm-12 col-md-3 col-lg-3">
              <div className="item bg-white shadow-sm p-3 text-center">
                <img
                  src="https://www.licious.in/_next/image?url=https%3A%2F%2Fdao54xqhg9jfa.cloudfront.net%2FOMS-ProductMerchantdising%2F788d3416-efa7-4297-4ab8-fc33c8a26409%2Foriginal%2FPDP_5._Country_Eggs_-_Pack_of_6_(1).jpg&w=750&q=75"
                  className="img-fluid"
                />
                ...
                <button
                  className="btn btn-success"
                  onClick={() => addToCart({ id: 4, price: 2, name: "Eggs" })}
                >
                  Add to Cart
                </button>
              </div>
